...
- Create PeriodSelectionMenu and RangedSelectionMenu classes
- Figure out a system to implement set alarm and set time - maybe create a child class RangedSelectionMenu which can take in functions with params
